  ...
  document.addEventListener('DOMContentLoaded', () => {
    ...
    if (document.querySelector('.js-blog')) {
      ...
      blogTween
        ...
        .staggerFrom('.js-blog-item', 0.5, { ease: Power1. easeIn, opacity: 0, x: 100}, 0.25)
        .from('.js-blog-left-decor', 0.5, {ease: Power3. easeOut, transformOrigin: '100% 50%', scale: 0})
        .from('.js-blog-right-decor', 0.5, {ease: Power3. easeOut, transformOrigin: '0 50%', scale: 0}, '-=0.5')
